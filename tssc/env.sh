...
export REKOR_HOST=https://rekor-server-tssc-tas.apps.rosa.wyuxg-eawch-zun.cspo.p3.openshiftapps.com
...
export TUF_MIRROR=https://tuf-tssc-tas.apps.rosa.wyuxg-eawch-zun.cspo.p3.openshiftapps.com
