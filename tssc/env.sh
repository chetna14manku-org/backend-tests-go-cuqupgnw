...
export IMAGE_URL=${IMAGE_URL-quay.io/chetna14manku_org/backend-tests-go-cuqupgnw:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/chetna14manku-org/backend-tests-go-cuqupgnw-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.rosa.wyuxg-eawch-zun.cspo.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.rosa.wyuxg-eawch-zun.cspo.p3.openshiftapps.com}
